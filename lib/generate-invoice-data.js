...
module.exports = student => {
  ...
  let notes2 = `Dersom noe ikke stemmer, ta kontakt med skolen på telefon: ${formatPhoneNumber(schoolPhone)}`
  if (studentType === 'larling') {
    notes1 = `Siste betaling leie av PC ${fornavn} ${etternavn}, ${basisgruppe}, ${schoolName}`
    notes2 = `Dersom noe ikke stemmer, ta kontakt med skolen på telefon: ${formatPhoneNumber(schoolPhone)}`
  }
  return {
    partNumber,
    amount,
